...
<title><s:property value="products[0].category.name"/> &nbsp;-&nbsp;商品列表</title>
...
<script type="text/javascript">
	...
	function initData(page){
		var p = page;
		window.location.assign("front/Product-list?categroyId=" + <s:property value='categroyId'/> + "&page=" + p)
	}
	...
	<div id="container">
		<div id="container1">
	    	<div class="directory">
	    		<div class="d-title">
	    			<h3>
	    				<s:property value="products[0].category.parent.parent.name"/> >
	    				<s:property value="products[0].category.parent.name"/> >
	    				<s:property value="products[0].category.name"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    				共<s:property value='total'/>个商品
	    			</h3>
	    		</div> 
	    	</div>
	    	<div class="p-main">
